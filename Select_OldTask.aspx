<%@ Page Title="" Language="C#" MasterPageFile="~/MainMasterAR.master" AutoEventWireup="true" CodeFile="Select_OldTask.aspx.cs" Inherits="Select_OldTask" %>
        ...
        <ContentTemplate>
            <div class="container" dir="rtl">
                <div class="ui blue inverted segment center aligned " style="width: 100%">
                    <h1>عرض بطاقات مهمة ادارية مورشفة</h1>
                </div>
                        ...
                        <div class="ui three column grid">
                            <div class="row">
                                <div class="column">
                                    ...
                                    <asp:TextBox ID="txtDateFrom" runat="server" class="ui input " onchange="changeborderColorafterfill(this)" ValidationGroup="1" placeholder="التاريخ " AutoPostBack="true" OnTextChanged="txtDateFrom_TextChanged" CssClass="center" Font-Size="Medium" TabIndex="1"></asp:TextBox>
                                <ajaxToolkit:CalendarExtender ID="CalendarExtender1" runat="server" TargetControlID="txtDateFrom" />
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="txtDateFrom" ValidationGroup="1" ErrorMessage=""></asp:RequiredFieldValidator>    
                                </div>
                                <div class="column">
                                    <asp:Label ID="Label1" runat="server" Font-Size="Large" Text="الفترة الي  " CssClass="valign-text-top"></asp:Label>
                                    <asp:TextBox ID="txtDateTo" runat="server" class="ui input " onchange="changeborderColorafterfill(this)" ValidationGroup="1" placeholder="التاريخ " CssClass="center" Font-Size="Medium" AutoPostBack="true" OnTextChanged="txtDateTo_TextChanged" TabIndex="2"></asp:TextBox>
                                <ajaxToolkit:CalendarExtender ID="CalendarExtender2" runat="server" TargetControlID="txtDateTo" />
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtDateTo" ValidationGroup="1" ErrorMessage=""></asp:RequiredFieldValidator>    
                                </div>
                                <div class="column">
                                    <br />
