...
public partial class Add_PayMoney : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            try
            {
                string sql1 = @"select * from Application_Setting where User_Id=" + Session["Id"] + " and Appl_Id=33 and IsVaild=1";
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
     ...
     VALUES
           (@1,@2,@3,@4,@5)";
                dataObj.Execute(sql, DateTime.Parse(txtDate.Text),drpEmployee.SelectedItem.Value, float.Parse(txtAmount.Text),txtNotes.Text,"سند دفع");
