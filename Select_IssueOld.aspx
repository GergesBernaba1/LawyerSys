<%@ Page Title="" Language="C#" MasterPageFile="~/MainMasterAR.master" AutoEventWireup="true" CodeFile="Select_IssueOld.aspx.cs" Inherits="Select_IssueOld" %>
        ...
        <ContentTemplate>
            <div class="container" dir="rtl">
                <div class="ui blue inverted segment center aligned " style="width: 100%">
                    <h1>عرض بطاقات القضايا المرشفة</h1>
                </div>
