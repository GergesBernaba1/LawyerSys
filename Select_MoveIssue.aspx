<%@ Page Title="" Language="C#" MasterPageFile="~/MainMasterAR.master" AutoEventWireup="true" CodeFile="Select_MoveIssue.aspx.cs" Inherits="Select_MoveIssue" %>
                        ...
                        <div class="ui two column grid">
                            <div class="row">
                                 <div class="column">
                                    ...
                                    <asp:DropDownList ID="drpIssueNumber" runat="server" class="ui fluid selection dropdown" Font-Size="Medium" ValidationGroup="1" onchange="changeborderColorafterfill(this)" AutoPostBack="true" OnSelectedIndexChanged="drpIssueNumber_SelectedIndexChanged" CssClass="center" TabIndex="1"></asp:DropDownList>
                                     <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" InitialValue="أختار رقم القضية" ControlToValidate="drpIssueNumber" ValidationGroup="1" ErrorMessage=""></asp:RequiredFieldValidator>
                                 </div>
                                 <div class="column">
                                     <br />
