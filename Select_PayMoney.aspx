<%@ Page Title="" Language="C#" MasterPageFile="~/MainMasterAR.master" AutoEventWireup="true" CodeFile="Select_PayMoney.aspx.cs" Inherits="Select_PayMoney" %>
                        ...
                        <div class="ui two column grid">
                            <div class="row">
                                 <div class="column">
                                    ...
                                    <asp:DropDownList ID="drpEmployee" runat="server" class="ui fluid selection dropdown" onchange="changeborderColorafterfill(this)" ValidationGroup="1"  Font-Size="Medium" AutoPostBack="true" OnSelectedIndexChanged="drpEmployee_SelectedIndexChanged" CssClass="center" TabIndex="1"></asp:DropDownList>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="drpEmployee" InitialValue="اختار العميل" ValidationGroup="1" ErrorMessage=""></asp:RequiredFieldValidator>    
                                 </div>
                                <div class="column">
                                    <br />
                            ...
                            <div class="row">
                                <div class="column">
                                    ...
                                    <asp:TextBox ID="txtDateFrom" runat="server" class="ui input " placeholder="التاريخ " onchange="changeborderColorafterfill(this)" ValidationGroup="1"  AutoPostBack="true" OnTextChanged="txtDateFrom_TextChanged" CssClass="center" Font-Size="Medium" TabIndex="1"></asp:TextBox>
                                ...
                                <div class="column">
                                    ...
                                    <asp:TextBox ID="txtDateTo" runat="server" class="ui input " placeholder="التاريخ " onchange="changeborderColorafterfill(this)" ValidationGroup="1"  CssClass="center" Font-Size="Medium" AutoPostBack="true" OnTextChanged="txtDateTo_TextChanged" TabIndex="2"></asp:TextBox>
