<%@ Page Title="" Language="C#" MasterPageFile="~/MainMasterAR.master" AutoEventWireup="true" CodeFile="Add_ReceiveMoney.aspx.cs" Inherits="Add_ReceiveMoney" %>
                 ...
                 <div class="three fields ui raised segment form">
                    ...
                    <div class="field">
                        <div class="ui two column grid">
                            ...
                            <div class="row">
                                <div class="column">
                                    <asp:Label ID="Label3" runat="server" Font-Size="Large" Text="المبلغ"></asp:Label>
                                    <asp:TextBox ID="txtAmount" runat="server" placeholder="المبلغ" class="ui input " ValidationGroup="1" onchange="changeborderColorafterfill(this)"  CssClass="center" Font-Size="Medium" TabIndex="3"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtAmount" ValidationGroup="1" ErrorMessage=""></asp:RequiredFieldValidator>
                                </div>
                                <div class="column">
