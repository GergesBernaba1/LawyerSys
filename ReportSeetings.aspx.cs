...
public partial class ReportSeetings : System.Web.UI.Page
{
        ...
        if (!IsPostBack)
        {
            ...
            if (Request.QueryString["Id"].ToString() != null && Request.QueryString["Id"].ToString() != "")
            {
                try
                {
                    ...
                    string sql = @"ReportSeeting " + Request.QueryString["Id"].ToString();
                    ReportDocument reportdocument = new ReportDocument();
                    reportdocument.Load(Server.MapPath("Reports/RepAllSeeting.rpt"));
                ...
                {
                    Response.Redirect("Select_Sitting.aspx");
                }
            }
            else
            {
