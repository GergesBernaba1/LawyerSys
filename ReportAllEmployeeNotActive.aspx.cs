...
public partial class ReportAllEmployeeNotActive : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            try
            {
                ...
                string sql = @"ReportNotActiveEmployee";
                ReportDocument reportdocument = new ReportDocument();
                reportdocument.Load(Server.MapPath("Reports/RepAllEmployeesNotActive.rpt"));
