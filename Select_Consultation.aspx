<%@ Page Title="" Language="C#" MasterPageFile="~/MainMasterAR.master" AutoEventWireup="true" CodeFile="Select_Consultation.aspx.cs" Inherits="Select_Consultation" %>
                        ...
                        <div class="ui two column grid">
                            <div class="row">
                                 <div class="column">
                                    ...
                                    <asp:DropDownList ID="drpEmployee" runat="server" class="ui fluid selection dropdown" Font-Size="Medium" ValidationGroup="1" onchange="changeborderColorafterfill(this)" AutoPostBack="true" OnSelectedIndexChanged="drpEmployee_SelectedIndexChanged" CssClass="center" TabIndex="1"></asp:DropDownList>
                            ...
                            <div class="row">
                                <div class="column">
                                    ...
                                    <asp:TextBox ID="txtDateFrom" runat="server" class="ui input " placeholder="التاريخ " ValidationGroup="1" onchange="changeborderColorafterfill(this)" AutoPostBack="true" OnTextChanged="txtDateFrom_TextChanged" CssClass="center" Font-Size="Medium" TabIndex="1"></asp:TextBox>
                                ...
                                <div class="column">
                                    ...
                                    <asp:TextBox ID="txtDateTo" runat="server" class="ui input " placeholder="التاريخ " CssClass="center" ValidationGroup="1" onchange="changeborderColorafterfill(this)" Font-Size="Medium" AutoPostBack="true" OnTextChanged="txtDateTo_TextChanged" TabIndex="2"></asp:TextBox>
                                <ajaxToolkit:CalendarExtender ID="CalendarExtender2" runat="server" TargetControlID="txtDateTo" />
                                     <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server"  ControlToValidate="txtDateTo" ValidationGroup="1" ErrorMessage=""></asp:RequiredFieldValidator>
                                </div>
                            </div>
                        </div>
                    </div>
               ...
               <div class="three fields ui raised segment form">
                    ...
                    <div class="field">
                        <div id="Div1" dir="rtl" runat="server" style="height: 400px; width: 100%; left: 5%; right: 5%; margin: 2em auto; overflow-x: scroll">
                            <asp:GridView ID="gridSelect" class="ui celled table center aligned" AllowPaging="true" PageSize="5" runat="server" CellPadding="4" OnSelectedIndexChanged="gridSelect_SelectedIndexChanged" ForeColor="#333333" BorderColor="#CC9966" BorderStyle="None" BorderWidth="1px" GridLines="None" OnPageIndexChanging="gridSelect_PageIndexChanging" >
                                <Columns>    
